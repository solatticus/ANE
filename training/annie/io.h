...
// Same as training_dynamic/io.h but parameterized (no hardcoded DIM/HIDDEN/SEQ).
#pragma once
#include "config.h"
...
// Blob builders for const weights (mask)
...
// fp32 dynamic matmul I/O — packs activation + weight into [1, IC, 1, SEQ+OC]
